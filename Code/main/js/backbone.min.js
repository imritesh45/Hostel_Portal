  ...
  g.Events = {
    ...
    trigger: function (a) {
      ...
      for ((a = a.split(/\s+/)).push(null); (b = a.shift()); )
        e && a.push({ next: e.next, tail: e.tail, event: b }),
  ...
  f.extend(g.Model.prototype, g.Events, {
    ...
    set: function (a, b, c) {
      ...
      for (e in d)
        if (
          ((a = d[e]),
          f.isEqual(b[e], a) || delete k[e],
          c.unset ? delete b[e] : (b[e] = a),
          this._changing &&
            !f.isEqual(this._changed[e], a) &&
            (this.trigger("change:" + e, this, a, c), (this._moreChanges = !0)),
          delete this._changed[e],
          !f.isEqual(n[e], a) || f.has(b, e) != f.has(n, e))
        )
          this._changed[e] = a;
      h ||
        (!c.silent && this.hasChanged() && this.change(c),
        (this._setting = !1));
      return this;
    },
    unset: function (a, b) {
    ...
    hasChanged: function (a) {
      return !arguments.length
        ? !f.isEmpty(this._changed)
        : this._changed && f.has(this._changed, a);
    },
  ...
  f.extend(g.History.prototype, g.Events, {
    ...
    start: function (a) {
      ...
      if ((b = x.exec(navigator.userAgent.toLowerCase()) && (!b || 7 >= b)))
        (this.iframe = h('<iframe src="javascript:0" tabindex="-1" />')
          .hide()
          .appendTo("body")[0].contentWindow),
          this.navigate(a);
      this._hasPushState
        ? h(window).bind("popstate", this.checkUrl)
        : this._wantsHashChange && "onhashchange" in window && !b
        ? h(window).bind("hashchange", this.checkUrl)
      ...
      this._wantsPushState &&
        ...
        b &&
        a.hash &&
        ((this.fragment = a.hash.replace(m, "")),
    ...
    checkUrl: function () {
      ...
      a == this.fragment &&
        this.iframe &&
        (a = this.getFragment(this.iframe.location.hash));
    ...
    navigate: function (a, b) {
      ...
      var c = (a || "").replace(m, "");
      this.fragment == c ||
        this.fragment == decodeURIComponent(c) ||
        (this._hasPushState
          ...
          ? ((this.fragment = c),
            ...
            this.iframe &&
              c != this.getFragment(this.iframe.location.hash) &&
